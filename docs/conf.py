# -*- coding: utf-8 -*-
#
# pambox documentation build configuration file, created by
...
# Mock import so that the documentation can be build on ReadTheDocs.org
import mock
...
try:
    ...
    print 'To build the documentation, The distribution information of pambox()'
...
latex_documents = [
  ('index', 'pambox.tex', u'pambox Documentation',
   u'Author', 'manual'),
]
