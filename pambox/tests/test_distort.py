...
def test_spec_sub_0dB_kappa_1():
    mat = sio.loadmat('./test_files/test_spec_sub_complete.mat',
                      squeeze_me=True)
    signal = mat['input']
    noise = mat['noise']
    w = mat['W']
...
def test_spec_sub_0dB_kappa_0():
    mat = sio.loadmat('./test_files/test_spec_sub_0dB_kappa_0.mat',
                      squeeze_me=True)
    signal = mat['test']
    noise = mat['noise']
    w = mat['W']
...
def test_level_adjustment_and_spec_sub_processing():
    mat = sio.loadmat('./test_files/setting_level_and_spec_sub_processing_v1.mat',
                      squeeze_me=True)
    x = mat['x']
